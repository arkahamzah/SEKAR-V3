...
@section('content')
<div class="relative w-full min-h-[calc(100vh-3.5rem)] bg-cover bg-center" style="background-image: url('{{ asset('asset/graha-merah-putih.jpg') }}');">
    ...
    <div class="relative z-10 flex items-center justify-center h-full p-4 py-12 text-white">
        <div class="max-w-4xl text-center">
            ...
            <div class="max-w-3xl mx-auto bg-white rounded-lg p-6 shadow-lg" relative style="font-family: 'Times New Roman', Times, serif;" >
                ...
                <div class="relative z-10">
                    <h2 class="text-2xl font-semibold text-gray-900" style="text-shadow: none;">Sambutan Ketua Umum</h2>
                    
                    <div class="mt-4 text-base leading-relaxed text-gray-800 text-left px-4" style="text-shadow: none;">
                    ...
                    <div class="mt-8 text-left">
                        ...
                        @if($ketuaUmum)
                            <p class="mt-2 font-bold text-lg text-gray-900" style="text-shadow: none;">{{ $ketuaUmum->nama }}</p>
                            <p class="text-sm text-gray-700" style="text-shadow: none;">{{ Str::title(strtolower($ketuaUmum->jabatan)) }} </p>
                        @else
                            <p class="mt-6 font-bold text-lg text-gray-900" style="text-shadow: none;">Nama Ketua Umum</p>
                            <p class="text-sm text-gray-700" style="text-shadow: none;">Ketua Umum SEKAR Telkom</p>
                        @endif
                    </div>
                </div>
            </div>
